<?php   
    ...
    $q = $db->prepare("INSERT INTO comptesupprimer (`id`, `Nom`, `Prenom`, `email`, `MDP`, `Raison`, `adresse`, `codePostal`, `ville`, `tel`, `id_cat`) VALUES (" . $_SESSION['id'] . ", '" . $_SESSION['nom'] . "', '" . $_SESSION['prenom'] . "', '" . $_SESSION['email'] . "', '" . $_SESSION['mdp'] ."', '" . $_SESSION['raison'] . "', '" . $_SESSION['adresse'] . "', " . $_SESSION['codePostal'] . ", '" . $_SESSION['ville'] . "', " . $_SESSION['tel'] . ", 1)");
    $q->execute();
