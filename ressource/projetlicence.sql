...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : mar. 01 déc. 2020 à 07:47
...
--
-- Structure de la table `comptesupprimer`
--

DROP TABLE IF EXISTS `comptesupprimer`;
CREATE TABLE IF NOT EXISTS `comptesupprimer` (
  `id` int NOT NULL,
...
INSERT INTO `conseils` (`id_cons`, `titre`, `libelle`, `video`, `id_cat_prod`) VALUES
(1, 'Comment visser une vis', 'Avant de procéder au vissage, appliquez de la paraffine ou de la bougie sur le filet de la vis pour faciliter sa pénétration. Vissez progressivement : adaptez la vitesse de vissage au fur et à mesure.\r\nRegardez ce tuto pour visser comme un pro', 'https://www.youtube.com/embed/6T9n-bxfU0E', 0),
(2, 'Quelle clé pour serrer un écrous, un raccord, ou un boulon ?', 'Vidéo d\'aide', 'https://www.youtube.com/embed/2BDq-e4fAGw', 0),
(5, 'Comment mettre une cheville', 'Video testsqdqsd', 'https://youtu.be/NCCEwuJ2Ats', 0);
...
(17, '', 50, 2, 'Pneu Poulie', 'C\'est une poulie pneu', 2, 6),
...
(5, 20, '2020-11-29', '2020-12-17'),
(6, 30, '2020-11-29', '2020-12-17');
...
(1234567891, 'Six', 'Tristan', 'sixtristan@orange.fr', 'tortue93', 'lol mdr', 'dsdq', 59139, 'Wattginies', '26522156', 1);
COMMIT;
