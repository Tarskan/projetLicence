        ...
        <div class="container-fluid">
            <div class="row ">
                <div class="col-2 bg-dark">
                    ...
                    <a class="nav-link active" id="v-pills-acceuil-tab" data-toggle="pill" href="#v-pills-acceuil" role="tab" aria-controls="v-pills-acceuil" aria-selected="true">Acceuil</a>
                    <a class="nav-link" id="v-pills-categorie-tab" data-toggle="pill" href="#v-pills-categorie" role="tab" aria-controls="v-pills-categorie" aria-selected="false">Categorie</a>
                    <a class="nav-link" id="v-pills-produit-tab" data-toggle="pill" href="#v-pills-produit" role="tab" aria-controls="v-pills-produit" aria-selected="false">Produit</a>
                    <a class="nav-link" id="v-pills-conseil-tab" data-toggle="pill" href="#v-pills-conseil" role="tab" aria-controls="v-pills-conseil" aria-selected="false">Conseil</a>
                    <a class="nav-link" id="v-pills-utilisateur-tab" data-toggle="pill" href="#v-pills-utilisateur" role="tab" aria-controls="v-pills-utilisateur" aria-selected="false">Utilisateur</a>
                    <a class="nav-link" id="v-pills-commande-tab" data-toggle="pill" href="#v-pills-commande" role="tab" aria-controls="v-pills-commande" aria-selected="false">Commande</a>
                    </div>
                </div>
                <div class="col-10">
